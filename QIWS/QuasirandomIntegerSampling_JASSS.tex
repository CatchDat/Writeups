...
Using IPF with a unity seed is equivalent to populating each state proportionally to the probability of occupancy of the state. This solution maximises entropy.

Sampling algorithms generally cannot achieve the same entropy since they only populate states with integer populations. 
...
TODO this is propbably pointless

Perhaps do more histograms...

R\^2?

An analysis was performed on two evenly distributed
...
can be seen in figure \ref{fig:hist_sampling}.

\begin{figure}[!t]
\centering
\includegraphics[width=0.498\linewidth]{figures/hist_pseudo_1} 
\includegraphics[width=0.498\linewidth]{figures/hist_quasi_1} 
\caption{Distribution of p-values of QIWS using pseudorandom (left) and quasirandom (right) sampling, mean population density 1.0}
...
\caption{Distribution of p-values of QIWS using pseudorandom (left) and quasirandom (right) sampling, mean population density 100.0}
