...
normalised performance values. For reference, the hardware used was a fairly recent, fairly standard desktop PC and the performance tests (1000 runs) took seconds to run.
